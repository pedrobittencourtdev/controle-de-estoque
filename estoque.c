...
// Remove um produto da lista, de acordo com  a escolha do usuario.
void removerProduto(Produto **head, int codigo){
...
// Exibe os nomes do produtos emm ordem alfabética.
void exibirOrdenadoPorNome(Produto *head) {
...
// Realiza uma busca binária, de acordo com opçào dom usuário.
int buscaBinariaCodigo(Produto **arr, int n, int codigo) {
...
// Caso o usuário decida atualizar um produto da lista. 
void atualizarProduto(Produto *head, int codigo) {
...
// Aerta estoque baixo e produtos vencidos
void alertarEstoque(Produto *head, int limiteEstoque) {
